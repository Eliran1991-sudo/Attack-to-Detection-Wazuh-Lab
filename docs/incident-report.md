...
- Recommendation: retain the focused Sysmon configuration and build dashboard queries for Event IDs 1, 3, 11, and 22.

## Analyst conclusion

The test achieved its goal without malware or unsafe exploitation. Endpoint telemetry was generated and captured, the Wazuh collection path was operational, and firewall filtering reduced the exposed Windows attack surface.
